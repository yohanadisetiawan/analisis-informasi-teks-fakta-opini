...
sprites.onOverlap(SpriteKind.Player, SpriteKind.NPC, function on_on_overlap(sprite: Sprite, otherSprite: Sprite) {
    ...
    ModeDialog = true
    if (ModeDialog == true) {
        dbSoal = ["Bagaimana cara kerja jantung dalam tubuh manusia?", "Bagaimana pandanganmu tentang teknologi canggih saat ini?", "Apa yang menyebabkan gempa bumi?", "Apakah kamu lebih suka musik klasik atau musik pop?", "Sebutkan tiga fakta tentang planet-planet dalam tata surya kita!", "Bagaimana pandanganmu tentang peran media dalam masyarakat?", "Bagaimana cara kerja otak dalam tubuh manusia?", "Apakah kamu lebih suka film Hollywood atau film Indonesia?", "Praditya berpikir teknologi canggih saat ini adalah bencana bagi masyarakat. Semua orang terlalu tergantung pada telepon pintar dan teknologi lainnya, sehingga kita kehilangan keterampilan sosial yang penting. Kita perlu kembali ke cara hidup yang lebih sederhana dan mengurangi ketergantungan pada teknologi.", "Dzakir berpikir kita harus mengurangi pemakaian plastik sebanyak mungkin. Plastik merusak lingkungan dan membahayakan hewan-hewan laut. Kita harus lebih bertanggung jawab dan memakai alternatif yang lebih ramah lingkungan."]
        jwbSoal = ["Fakta", "Opini", "Fakta", "Opini", "Fakta", "Opini", "Fakta", "Opini", "Fakta", "Opini"]

...
game.showLongText("Cara Main:\\nGunakan tombol panah untuk bergerak dan tombol A untuk berinteraksi.\\nKumpulkan poin lebih dari 70 untuk menyelesaikan game ini dengan bicara pada NPC yang tersedia.", DialogLayout.Full)
game.showLongText("Jawaban yang benar mendapat 10 poin, jika salah berkurang 5 poin.\\nPerhatikan waktu yang tersedia.\\nAkhir permainan cari NPC Jubah Emas.\\nSELAMAT BERMAIN.\\nBismillah...", DialogLayout.Full)
